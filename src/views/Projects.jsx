      ...
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4  pt-24 pb-12">
        ...
        <div className="mt-8 flex justify-between items-stretch flex-wrap">
          ...
          <Card 
            ...
            description="To-do list helps the user to manage time effectively."
            image={`${process.env.PUBLIC_URL}/to-do-list-image.jpg`}
            link="#"
          />
          <Card 
            title="A Chat Application"
            description="A real-time chat app using Socket.io and Node.js. which helps users to chat in real time and share images."
            image={`${process.env.PUBLIC_URL}/chat app image.png`}
            link="#"
          />
          <Card 
            title="Weather Dashboard"
            description="Displays weather info using OpenWeather API"
            image={`${process.env.PUBLIC_URL}/weather dashboard image.jpeg`}
            link="#"
          />
          <Card  
